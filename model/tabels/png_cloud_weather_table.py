# -*- encoding: utf-8 -*-
'''
Created on 2024/10/21 18:07:19
...
class PngCloudWeatherTable(Base):
    __tablename__ = 'png_cloud_weather_table'
    ...
    def __repr__(self):
        return (f"<PngCloudWeatherTable(data_id={self.data_id}, data_type={self.data_type}, "
