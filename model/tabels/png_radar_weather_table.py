# -*- encoding: utf-8 -*-
'''
Created on 2024/10/21 18:07:28
...
class PngRadarWeatherTable(Base):
    __tablename__ = 'png_radar_weather_table'
    ...
    def __repr__(self):
        return (f"<PngRadarWeatherTable(data_id={self.data_id}, data_type={self.data_type}, "
